...
// GetEventsBySensorIDWithDate mocks base method.
func (m *MockEventRepository) GetEventsBySensorIDWithDate(ctx context.Context, id int64, start, end time.Time) ([]domain.Event, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetEventsBySensorIDWithDate", ctx, id, start, end)
	ret0, _ := ret[0].([]domain.Event)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetEventsBySensorIDWithDate indicates an expected call of GetEventsBySensorIDWithDate.
func (mr *MockEventRepositoryMockRecorder) GetEventsBySensorIDWithDate(ctx, id, start, end interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetEventsBySensorIDWithDate", reflect.TypeOf((*MockEventRepository)(nil).GetEventsBySensorIDWithDate), ctx, id, start, end)
}
